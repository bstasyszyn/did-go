...
func generateRecoverRequest(recoveryKey *ecdsa.PrivateKey, recoveryCommitment string, p protocol.Protocol) ([]byte, error) {
	...
	info := &clientx.RecoverRequestInfo{
...
func generateCreateRequest(recoveryCommitment, updateCommitment string, p protocol.Protocol) ([]byte, error) {
	...
	return clientx.NewCreateRequest(info)
}
...
func generateDeactivateRequest(recoveryKey *ecdsa.PrivateKey) ([]byte, error) {
	...
	info := &clientx.DeactivateRequestInfo{
	...
	return clientx.NewDeactivateRequest(info)
}
...
func generateUpdateRequest(updateKey *ecdsa.PrivateKey, updateCommitment string, p protocol.Protocol) ([]byte, error) {
	...
	info := &clientx.UpdateRequestInfo{
	...
	return clientx.NewUpdateRequest(info)
}
