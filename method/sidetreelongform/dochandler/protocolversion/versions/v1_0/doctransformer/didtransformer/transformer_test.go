...
import (
	...
	"github.com/trustbloc/did-go/method/sidetreelongform/dochandler/protocolversion/versions/v1_0/doctransformer/metadata"
)
...
func TestNewTransformer(t *testing.T) {
	...
	transformer = New(WithIncludePublishedOperations(true))
...
func TestTransformDocument(t *testing.T) {
	...
	t.Run("success - include operations (published/unpublished)", func(t *testing.T) {
		trans := New(WithIncludePublishedOperations(true))
